...
public class UserController {
    ...
    @GetMapping("/user/update/{userId}/{username}/{password}/")
    public String updateUser(@PathVariable int userId, @PathVariable String username, @PathVariable String password) {
